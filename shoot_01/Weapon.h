 ...
 */
UCLASS()
class SHOOT_01_API AWeapon : public AItem
{
	GENERATED_BODY()
...
private:
	...
	/** Amout of damage caused by a bullet */
	...
	/** Curve for the slode displacement*/
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = Pistol, meta = (AllowPrivateAccess = "true"))
	UCurveFloat* SlideDisplacementCurve;;

	/** Timer handle for updating Slide D isplacement*/
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = DataTable, meta = (AllowPrivateAccess = "true"))
		UParticleSystem* MuzzleFlash;
	/** Sound palyed when the weapon is fired */
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = DataTable, meta = (AllowPrivateAccess = "true"))
		USoundCue* FireSound;
	...
	/** FName fjor the Reload Montage Section */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Weapon Properties", meta = (AllowPrivateAccess = "true"))
		FName ReloadMontageSection;
...
public:
	...
	FORCEINLINE USoundCue* GteFireSound() const { return FireSound;}

	FORCEINLINE int32 GetAmmo() const { return Ammo; }
	FORCEINLINE int32 GetMagazineCapacity() const { return MagazineCapacity; }

	/** Called form Character calss when firing weapon*/
	void DecrementAmmo();
