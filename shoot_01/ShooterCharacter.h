...
struct FInterpLocation
{
	...
	// Number if items interping to/at this scene comp location
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly)
		int32 ItemCount;
};
...
private:
	...
	///** 让它能在任何地方编辑，因为我们想在蓝图中设置 SoundCue*/
	...
	/** Default camera field of view value*/   //视场（Field of View）
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Combat, meta = (AllowPrivateAccess = "true"))
	float CameraDefaultFOV;
	/** Field of view alue for when zoomed in*/  //缩放 (zoomed)
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Combat, meta = (AllowPrivateAccess = "true"))
	float CameraZoomedFOV;
	/** Current fied of view this frame*/
	...
	UPROPERTY(VisibleAnywhere,BlueprintReadWrite, Category = Crosshairss, meta = (AllowPrivateAccess = "true"))
	...
	/** 准星扩散 默认系数*/
	UPROPERTY(EditAnywhere,BlueprintReadWrite,category = Crosshairss, meta = (AllowPrivateAccess  = "true"),meta = (ClampMin = "0.0", ClampMax = "1.0", UIMin = "0.0", UIMax = "1.0"))
	float DefaultSpreadsScale;
	...
	/** Distance outward form the camera for the interp*/
	...
	/** Montage for Equiping animations*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Combat, meta = (AllowPrivateAccess = "true"))
		UAnimMontage* EquipMontage;

	/** Transform of the cli when we first grabthe clip during reloading */
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = Combat, meta = (AllowPrivateAccess = "true"))
	...
	/** Half height of hte capsule when not crouching */
	...
	/** Groud friction while not crouching*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Movement, meta = (AllowPrivateAccess = "true"))
		float BaseGroudFriction;
	/** Groud friction while crouching*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Movement, meta = (AllowPrivateAccess = "true"))
		float CrouchingGroudFriction;
	...
	/** Timer to wait before we can play another Pickup Sound*/
	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = Items, meta = (AllowPrivateAccess = "true"))
	...
	/** Sund made when Character gets hit by a mellee attack */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Combat, meta = (AllowPrivateAccess = "true"))
	...
	/** Blood splatter partickes for melle hit*/
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Combat, meta = (AllowPrivateAccess = "true"))
...
protected:
	...
	*/
	...
	/**               //参数速率（Rate）是一种归一化速率，即1.0表示所需速率的100%
	...
	* @param Value  The input calue from mouse movement
	*/
	...
	*/
	...
	/** Called when the Fire Button is pressd*/
	void FireWeapon();

	//bool GetBeamEndLoacation(const FVector& MuzzleSocketLocation, FVector& OutBeamLocation);
	bool GetBeamEndLoacation(const FVector& MuzzleSocketLocation, FHitResult& OutHitResult);

	/** Set bAAiming to true or false with button press*/
	...
	/** Line trace for items under the crosshasirs*/
	...
	UFUNCTION(BlueprintCallable)
	EPhysicalSurface GetSurfaceType(); 	//void Footstep();
...
public:
	...
	// Returns the index in InterpLcoation array with lowest Itemcount
